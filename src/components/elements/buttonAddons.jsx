            ...
            <div>
                  ...
                  <div className="relative flex items-center mt-2">
                        <input
                              ...
                              value={value}
                              onChange={onChange}
                              className="px-5 border border-gray-200 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 block w-full placeholder-gray-400/70 dark:placeholder-gray-500 py-2.5 rounded-lg text-gray-700  focus:outline-none focus:ring focus:ring-opacity-40 dark:bg-gray-900 dark:text-gray-300"
                        />
                        <button
