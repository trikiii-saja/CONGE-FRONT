...
const AlertPop = ({ message, status }) => {
      let bgColor, iconColor, iconPath, titleColor;
      ...
      switch (status) {
            ...
            case 'warning':
                  ...
                  titleColor = 'text-yellow-400 dark:text-yellow-300';
                  iconPath = (
                        <path d="M20 3.33331C10.8 3.33331 3.33337 10.8 3.33337 20C3.33337 29.2 10.8 36.6666 20 36.6666C29.2 36.6666 36.6667 29.2 36.6667 20C36.6667 10.8 29.2 3.33331 20 3.33331ZM21.6667 28.3333H18.3334V25H21.6667V28.3333ZM21.6667 21.6666H18.3334V11.6666H21.6667V21.6666Z" />
                  );
                  break;
      ...
      return (
            <div className={`flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800`}>
                  ...
                  <div className="px-4 py-2 -mx-3">
                        <div className="mx-3">
                              <span className={`font-semibold ${titleColor}`}>{status.charAt(0).toUpperCase() + status.slice(1)}</span>
