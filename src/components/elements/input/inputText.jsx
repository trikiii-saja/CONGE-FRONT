...
export default function InputText({ label, placeHolder, message, topLink, disable = false, prefixIcon, error = false, secure = false, type = "text", link, to, onChange, value, name }) {
      ...
      return (
            <div className='w-full'>
                  ...
                  <div className="flex items-center justify-between">
                        {label != null && (<label htmlFor="email" className="block text-sm text-gray-500 dark:text-gray-300">
                              {label}
                        </label>)}
                  ...
                  <div className={`relative flex items-center mt-2`}>
                        ...
                        <input
                              ...
                              {...(disable === true ? { disabled: true } : { disabled: false })}
                              id={name}
